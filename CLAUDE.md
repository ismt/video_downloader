...
- Download target dir: `DOWNLOAD_DIR` module constant (`data/download`, relative to the repo root, gitignored, created on import) — used as the file-picker `initialdir` and in `file_name_format`/`file_name_format_audio`.
